 ...
 * @version $Id$
 */
class Aloi_Phruts_Util_PropertyMessageResourcesFactory extends Aloi_Phruts_Util_MessageResourcesFactory {
	/**
	...
	public function createResources($config) {
		...
		return new Aloi_Phruts_Util_PropertyMessageResources($config, $this->returnNull);
	}
}
?>
