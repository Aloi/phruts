 ...
 * @version $Id$
 */
class Aloi_Phruts_Config_Action {
	/**
	 ...
	 */
	public function setModuleConfig(Aloi_Phruts_Config_ModuleConfig $moduleConfig) {
		if ($this->configured) {
     ...
     *
     * @exception Aloi_Serphlet_Exception_IllegalState if this module configuration
     *  has been frozen
     */
